...
func NewProvider(providerConfig options.Provider) (Provider, error) {
	...
	case options.RBHubProvider:
		return NewRBHubProvider(providerData), nil
...
func providerRequiresOIDCProviderVerifier(providerType options.ProviderType) (bool, error) {
	switch providerType {
	case options.BitbucketProvider, options.DigitalOceanProvider, options.FacebookProvider, options.RBHubProvider, options.GitHubProvider,
